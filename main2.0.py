...
def main():
    ...
    while True:
        ...
        if not game_over and snake_direction is not None:
            ...
            # Verificar se a cobra passou do centro da tela para a direita quando o semáforo está vermelho
            if snake_direction == 'RIGHT' and head_x >= WIDTH // 2 and semaphore_color == RED:
                game_over = True
        ...
        if game_over:
            ...
            draw_text(screen, f"Pontuação: {
                      score}", 30, WHITE, (WIDTH // 2, 30))
